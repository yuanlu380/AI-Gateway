...
// Model Gateway models array - declares which models are available through APIM
...
// 6. Model Gateway Connection - Routes LLM calls from Foundry through APIM
...
output modelGatewayConnectionName string = modelGatewayConnection.name
